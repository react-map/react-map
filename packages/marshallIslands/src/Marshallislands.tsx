...
export interface MarshallislandsProps {
...
const Marshallislands = ({
  ...
  disableHover = false,
  borderStyle,
}: MarshallislandsProps) => {
  if (type === 'select-single') {
    return (
      <MarshallislandsSingle
        type="select-single"
        size={size}
        mapColor={mapColor}
