...
export interface UnitedarabemiratesProps {
...
const Unitedarabemirates = ({
  ...
  disableHover,
  borderStyle,
}: UnitedarabemiratesProps) => {
  if (type === 'select-single') {
    return (
      <UnitedarabemiratesSingle
        type="select-single"
        size={size}
...
const UnitedarabemiratesSingle = ({
  size,
  mapColor,
  strokeColor,
  selectColor,
...
const UnitedarabemiratesMultiple = ({
  size,
  selectColor,
  mapColor,
  strokeColor,
