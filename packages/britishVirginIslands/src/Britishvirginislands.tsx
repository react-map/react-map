...
export interface BritishvirginislandsProps {
...
const Britishvirginislands = ({
  ...
  disableHover = false,
  borderStyle,
}: BritishvirginislandsProps) => {
  if (type === 'select-single') {
    return (
      <BritishvirginislandsSingle
        type="select-single"
        size={size}
        mapColor={mapColor}
...
const BritishvirginislandsSingle = ({
  size,
  mapColor,
  strokeColor,
  selectColor,
...
const BritishvirginislandsMultiple = ({
  size,
  mapColor,
  strokeColor,
  selectColor,
