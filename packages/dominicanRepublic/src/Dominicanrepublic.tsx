...
const Dominicanrepublic = ({
  ...
  hintPadding,
  hintBorderRadius,
}: DominicanrepublicProps) => {
  if (type === 'select-single') {
    return (
      <DominicanrepublicSingle
        type="select-single"
        size={size}
...
const DominicanrepublicMultiple = ({
  size,
  selectColor,
  mapColor,
  strokeColor,
...
export interface DominicanrepublicProps {
